...
class OnWaitingTeacherCrudController extends AbstractCrudController
{
    ...
    {
        return $crud
            ->setPageTitle(Crud::PAGE_INDEX, "Professeurs en attente d'activation")
    ...
    {
        $validate = Action::new('validate', 'Valider le professeur')
    ...
    public function createIndexQueryBuilder(SearchDto $searchDto, EntityDto $entityDto, FieldCollection $fields, FilterCollection $filters): QueryBuilder
    {
        return parent::createIndexQueryBuilder($searchDto, $entityDto, $fields, $filters)
            ...
            ->setParameter('status', Teacher::STATUS_WAITING);
    }
}
