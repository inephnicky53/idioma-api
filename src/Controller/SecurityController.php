...
class SecurityController extends AbstractController
{
    ...
    public function login(AuthenticationUtils $authenticationUtils): Response
    {
        ...
        return $this->render('security/login.html.twig', [
            ...
            'logo' => '<img src="./images/logo.png" alt="image" style="margin-bottom: 10px; width: 150px"/>',
    ...
    public function connectGoogleCheckAction(ClientRegistry $clientRegistry): void
    {
    }
    ...
    public function connectFacebookCheckAction(ClientRegistry $clientRegistry): void
    {
    }
