 ...
 */
class SecurityCustomJWTAuthenticator implements AuthenticatorInterface
{
    /**
    ...
    {
        dd('// TODO: Implement createToken() method.');
     ...
     * {@inheritdoc}
     */
    public function onAuthenticationFailure(Request $request, AuthenticationException $authException): ?\Symfony\Component\HttpFoundation\Response
    {
        dd('// TODO: Implement createToken() method.');
    ...
    {
        dd('// TODO: Implement authenticate() method.');
    }
    ...
    protected function getPreAuthenticationTokenStorage(): TokenStorageInterface
    {
    ...
    {
        return new Response("on va voir");
    }
}
