...
interface WalletInterface
{
    ...
    public function addToWallet(float $amount, string $currency = Idioma::CURRENCY_DEFAULT): self;
    public function debitToWallet(float $amount, string $currency = Idioma::CURRENCY_DEFAULT): self;
    public function supportWallets(array $currencies = Idioma::CURRENCY_SUPPORTS): self;
