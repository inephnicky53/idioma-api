...
final readonly class TeacherSelfDisponibilitiesAdvancedProvider implements ProviderInterface
{
    ...
    private function isDisponibilityActive($teacher, Disponibility $disponibility): bool
    {
